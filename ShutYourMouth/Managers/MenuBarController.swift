...
final class MenuBarController: NSObject {
    ...
    private let log = Logger(subsystem: "com.andrieiev.shutyourmouth", category: "MenuBarController")
    ...
    private func configureStatusItem() {
        ...
        updateIcon()
        button.toolTip = "Shut Your Mouth — click to toggle mute, right-click for menu"
        button.target = self
